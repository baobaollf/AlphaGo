...
import * as alphaCityList from '../../assets/data/alphacityFront.json';
        ...
        return (
            <div className="dashboard-container">
                ...
                <div className="left-side">
                    <p className="promo-text">{this.state.name}</p>
                    <p className="small-promo-text">{this.state.snippet}</p>
                    <div>
                    ...
                    <div>
                        <DaySeletcor day={this.state.day} setDay={this.setDay} />
                        <NextPageButton
                            data={alphaCityList}
                            city={this.state.city}
                            coordinates={this.state.coordinates}
